...
#put the case before defining? or after?
def sce1_opt1
  # sce1_opt = gets.chomp.to_s.downcase
...
def scenario2
  ...
  until ["shaggy and scooby", "1", "the rest of the gang", "2", "wait in the mystery mobile", "3"].include?(sce2)
    puts "please submit a valid answer.
    \n Your options are:
    \n 1 = Shaggy and Scooby
    \n 2 = The rext of the gang
  ...
  case sce2
    ...
    when "the rest of the gang", "2"
      rest_of_the_gang2
    when "go wait in the Mystery Mobile", "3"
      mystery_mobile2
    else
      puts "Please type in a valid response.
      \nOptions: Shaggy and Scooby, the rest of the gang, wait in the Mystery Mobile"
...
def sce2_opt3
  ...
  #     case sce3
  #     when "shaggy and scooby", "1"
  #       puts """The Big Top is all lit up, and the spotlight is shining on a...
  #       GHOST CLOWN!"""
  #       puts "\nDo you want to:
  #       \n1 Run Away
  #       \n2 Hide
  #       \n3 Run towards the ghost?"
  #       #sce3_opt3 = gets.chomp.to_s.downcase
  #     when "the rest of the gang", "2"
  #       puts """The circus has a bunch of offices behind the big top.
  #       When they get there, they find finacial documents that show that the circus was failing!
  #       The owner filed for bankruptcy, citing supernatural happenings."""
  #       puts "\nDo you want to:
  #       \n1 = Find Shaggy and Scooby
  #       \n2 = Run Away"
  #       #sce3_opt2 = gets.chomp.to_s.downcase
  #     when "go wait in the Mystery Mobile", "3"
  #       puts "\nLooks like you will never solve the mystery."
  #     else
  #       puts "Please type in a valid response.
