...
def scenario2
  puts "\n One of the gangs friends, local dog trainer Buck Masters,
  \nis worried about a series of Dog-nappings!"
  puts "The best way to see what is happening, is to draw out the Dog-nappers.
  \nYou, and Shaggy and Scooby are going to act as decoys. So are you in?"
  puts ""
